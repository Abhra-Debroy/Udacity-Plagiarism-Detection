...
if __name__ == '__main__':
    ...
    parser.add_argument('--hidden_dim', type=int, default=15, metavar='S',
                        help='hidden dimension (default: 15)')
    parser.add_argument('--output_dim', type=int, default=2, metavar='S',
                        help='output dimention (default: 2)')
